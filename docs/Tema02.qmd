...
* La mayoría de operaciones pueden realizarse combinando 5 "verbos" <!--: `select()`, `filter()`, `mutate()`, `arrange()` y `summarize()` (más `%>%` y `group_by()`)-->
  ...
  * NOTA: existe una colección de ["chuletas"](https://rstudio.com/resources/cheatsheets/) de R, p.e., para [transformación](https://raw.githubusercontent.com/rstudio/cheatsheets/master/translations/spanish/data-transformation_Spanish.pdf).
...
```
<center>
![](figure/tidyvsmessy01_n.png){width=55%}
</center>

<center>
![](figure/tidyvsmessy02_n.png){width=45%}
</center>
...
<center>
![](figure/tidyvsmessy04a_n.png){width=55%}
</center>
