...
subtitle: "kNN, 'Naive Bayes', SVM. Redes Neuronales. 'Ensemble Learning' y 'Boosting'"
author:
    - "Pedro Albarrán"
    - "Alberto Pérez"
...
![](figure/knn_cropped-1.png){width=80% fig-align="center"}
...
::: {}
![](figure/SVM_hiper.png){width="70%" fig-align="center"}


:::

::: {}
![](figure/SVM_margin.png){width="70%" fig-align="center"}
...
![](figure/SVM_nonlinear.png){width="60%" fig-align="center"}
