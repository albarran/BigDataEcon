...
censo <- tryCatch(
    read_csv("data/census.csv") |> select(-1),
    error = function(e) 
      read_csv("https://raw.githubusercontent.com/albarran/00datos/refs/heads/main/census.csv") |> 
      select(-1)
  )
```
...
d) Repetir los apartados anteriores imputando los valores ausentes con `step_impute_knn()`. Comentar brevemente los resultados.
