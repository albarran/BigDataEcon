...
![](figure/overfitting01c.png){width=100% fig-align="center"}
...
::: {.column width="50%"}
  ...
  - **Sesgo**: error por especificar mal $f$ (ej., omitir variables, forma funcional incorrecta) →  *underfit* al perder relaciones relevantes
  
  - **Varianza**: fluctuaciones por *overfit* a características de cada muestra del entrenamiento
