...
# Regresiones
modelo1 <- lm(ventas ~ edad + I(edad^2) + descuento + mujer*renta + zona , data = datos)
summary(modelo1)


modelo1b <- lm(ventas ~ edad + I(edad^2) + descuento , data = datos)
summary(modelo1b)

modelo2 <- lm(ventas ~ descuento, data = datos)
summary(modelo2)

modelo3 <- lm(ventas ~ descuento + renta, data = datos)
summary(modelo3)
