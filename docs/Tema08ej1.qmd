...
* Además debemos tener cuidado con el orden de los pasos. La estandariación debe ser antes de la transformación en polinomios. Si se discretiza una variable continua, debemos hacer la discretización antes de la estandarización (o bien estandarizamos los puntos de corte).
