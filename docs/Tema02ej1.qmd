...
e. Representar la evolución temporal de las ventas anuales totales realizadas por los hombres y de las mujeres de las empresa.

    Presentar un gráfico de barras con el número de hombres y mujeres empleados en la empresa en cada año.
...
ggplot(data = datosAnioGenero) +
  geom_bar(aes(x = anio, y = num, fill = genero), stat = "identity", position = "dodge") +
  labs(title = "Número de empleados por género",
       x = "Año",
       y = "Número de empleados")

ggplot(data=empleados) + 
  geom_bar(aes(x=anio, fill=genero), position="dodge") +
  labs(title = "Número de empleados por género",
       x = "Año",
       y = "Número de empleados")
