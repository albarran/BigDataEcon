...
* Abrid la **carpeta** del informe (*File > Open Folder*) y cread el documento en *File > New File... > Quarto Document*; guardadlo **con extensión `.qmd`**

![](figure/positron-quarto-guia.png){width="98%" fig-align="center"}

::: {style="font-size: 78%;"}
**1** *Preview* renderiza · **2** guardar · **3** el `.html` creado, en la carpeta · **4** el **visor**, donde sale el resultado
