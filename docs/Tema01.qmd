...
* Se renderiza con **Preview**: el resultado sale en el **visor** de la derecha y, a la vez, se crea el fichero `.html` en la carpeta, donde lo vemos en el **Explorador**

    + para verlo **como lo verá quien lo reciba**, hay que abrirlo desde el **explorador de archivos del sistema**, haciendo doble clic: así el `.html` se abre en el **navegador**, y un `.pdf` o un `.docx` en su programa
