...
* Como en el Tema 00, se trabaja dentro de la **carpeta del proyecto** (*File > Open Folder*); el documento se crea en *File > New File... > Quarto Document* y se guarda **con extensión `.qmd`**

* **Renderizar** es procesar el documento —ejecutar su código y dar formato al texto— para producir el fichero final; en Positron, el botón **Preview**
...
* **Edit in Visual Mode** está en el menú `...` del editor, arriba a la derecha, y también en el menú del **botón derecho** sobre el documento

![](figure/positron-quarto-menu-modo.png){width="72%" fig-align="center"}

::: {style="font-size: 70%;"}
Para volver, la misma entrada dice *Edit in Source Mode*. Atajo en los dos sentidos: `Ctrl+Shift+F4`. También está en la paleta de comandos (`Ctrl+Shift+P`), que busca cualquier orden por su nombre
:::
