...
<!-- ENTREGA COMENTADA (15-sep-2026). Pedro: de momento fuera; se pondra cuando exista el
formulario de 2026-27. El enlace que habia (https://forms.gle/j5dQJwrhDqyoaKRf9) es del CURSO
PASADO: en el inventario de Drive, `Tema01ej` figura modificado el 19-oct-2025, asi que las
entregas de este curso habrian ido a la carpeta del anterior.
OJO al recuperarlo: NO se anuncia por UACloud (eso me lo invente yo).

## Entrega del ejercicio

::: {.callout-important}
El ejercicio se va haciendo **durante las clases del tema**, apartado a apartado, y se entrega al
terminarlo. El formulario de entrega se publicará aquí.
:::
