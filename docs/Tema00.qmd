...
# subtitle: "Análisis de Datos Multivariantes aplicado al Marketing - Curso 2024/25 \n\n Universidad de Alicante"
# subtitle: "Muestreo y Análisis de Datos - Universidad de Alicante"
subtitle: "Econometría II - Curso 2024/25 \n\n Universidad de Alicante"
...
* Un vector sólo puede contener objetos de un **unico tipo** elemental, que podemos conocer en el `Environment` o con `str()`
...
-   La biblioteca `httr` tiene la función `GET()` para descargar páginas web 
