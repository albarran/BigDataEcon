...
subtitle: "Árboles de Regresión y Clasificación. 'Random Forest'"
author:
    - "Pedro Albarrán"
    - "Alberto Pérez"
...
Boston  <- tryCatch({
            ...
            read_csv("https://raw.githubusercontent.com/albarran/00datos/refs/heads/main/BostonHousing.csv")
})
```
...
![](figure/tree.png){width=90% fig-align="center"}
...
* **Importancia** de las variables: la [biblioteca `vip`](https://koalaverse.github.io/vip/index.html) proporciona métricas sobre la influencia de cada predictor en las predicciones del modelo
  ...
  + otras generales: basadas en permutaciones, <!-- varianza o "flatness" en Partial Depence Plot de Friedman--> o en medidas de *Shapley*

<!---
  + variables usadas en nodos iniciales o más veces son más importantes

  + pero OJO porque no solo se considera la partición que finalmente aparece en el árbol sino algunas surrogadas:
  
    + lo menciona en el pdf de rpart en la sección de variable importance
...
* Más detalles en  https://cran.r-project.org/web/packages/vip/vip.pdf

* sorbre partial dependence plots (PDP), Friedman’s H statistics: para INTERACCIONES

https://lorentzen.ch/index.php/2024/01/07/explain-that-tidymodels-blackbox/
https://lorentzen.ch/index.php/2023/08/01/its-the-interactions/

* varias formas de explicación de modelos: vip, lime, DALEX
...
![](./figure/random-forest.png){width=55% fig-align="center"}
...
![](./figure/random-forest-machine-learning.png){width=40% fig-align="center"}
...
<!--  
* La importancia de las variables ayuda a generar hipótesis: de manera análoga a los p-valores (sin una inferencia estadística formal) o LASSO destaca qué variables considerar en modelos más simples y interpretables, como regresión o árboles.
-->
